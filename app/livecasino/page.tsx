...
const gamesList = [
  {
    id: 1,
    title: "Live Tombala",
    image: "/images/livecasino/livecasino_img1.jpg",
    provider: "mint"
  },
  {
    id: 2,
    title: "Horses 6",
    image: "/images/livecasino/livecasino_img2.jpg",
    provider: "evolution"
  },
  {
    id: 3,
    title: "All Games Lobby",
    image: "/images/livecasino/livecasino_img3.jpg",
    provider: "pragmatic"
  },
  {
    id: 4,
    title: "Motorbikes",
    image: "/images/livecasino/livecasino_img4.jpg",
    provider: "evolution"
  },
  {
    id: 5,
    title: "Speedway",
    image: "/images/livecasino/livecasino_img6.jpg",
    provider: "pragmatic"
  },
  {
    id: 6,
    title: "Greyhound Racing",
    image: "/images/livecasino/livecasino_img5.gif",
    provider: "evolution"
  }
];
    ...
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <div className="px-2 pt-2">
        <div className="w-full relative overflow-hidden rounded-lg">
          <Image 
            src="/images/livecasino/livecasino_img_jackpot.gif" 
            alt="Jackpot USD 42,682" 
            width={800} 
            height={200}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-yellow-400 text-4xl font-bold md:text-5xl" style={{ textShadow: "0 0 10px rgba(255, 215, 0, 0.7)" }}>
                USD 42,682
              </h2>
            </div>
          </div>
